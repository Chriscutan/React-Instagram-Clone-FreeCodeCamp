                ...
                <Flex flex={1} flexDir={"column"} px={10} display={{base: "none", md: "flex"}}>
                  <Flex alignItems={"center"} justifyContent={"space-between"}>
                    <Flex alignItems={"center"} gap={4}>
                      <Avatar src="/profilepic.png" size={"sm"} name="Chriscutan" />
                      <Text fontWeight={"bold"} fontSize={12}>Chriscutan</Text>
                    </Flex>

                    <Box _hover={{bg: "whiteAlpha.300", color: "red.600"}} borderRadius={4} px={1}>
                  ...
                  <VStack alignItems={"start"} maxH={"350px"} overflowY={"auto"}>
                    <Comment createdAt="1d ago" username="Chriscutan" profilePic="/profilepic.png" text="Dummy images from unsplash" />
                    <Comment createdAt="1d ago" username="Chriscutan" profilePic="/profilepic.png" text="Dummy images from unsplash" />
                    <Comment createdAt="1d ago" username="Chriscutan" profilePic="/profilepic.png" text="Dummy images from unsplash" />
                    <Comment createdAt="1d ago" username="Chriscutan" profilePic="/profilepic.png" text="Dummy images from unsplash" />
                    <Comment createdAt="1d ago" username="Chriscutan" profilePic="/profilepic.png" text="Dummy images from unsplash" />
